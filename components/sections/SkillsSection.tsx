...
export function SkillsSection() {
  return (
    <section id="skill" className="grid-bg min-h-screen w-full bg-background py-20 px-4 perspective-[1200px]">
            ...
            >
              ...
              <ul className="space-y-2">
                {skillGroup.items.map((skill, i) => (
                  <li key={i} className="text-gray-300 flex items-center transition-all group-hover:text-white">
